        ...
        <div class="product_view_page">
          ...
          <div class="container">
            <div class="product">
	            <a class="first" href="{#pt#}{$data.image}&h=650&fltr[]=wmi|/images/vizjel2.png|C|100" rel="gallery" title="{$data.title}"><img class="first" border="0" width="228" src="{#pt#}{$data.image}&w=228&zc=1" alt="{$data.imgalt}" title="{$data.imgtitle}" hspace="5" vspace="5" /></a>
