...
function post() {  
  ...
  document.getElementById('data').value = toSend;  
...
<h3>Dobozok sorrendjének szerkesztése</h3>

<form action="admin.php?mod=mainpageboxsort" method="post" id="f">
...
<table style="width: 600px;">
  <tr>
    ...
    <td>
      <input type="button" name="bk" onClick="javascript:document.location='admin.php?mod=mainpageboxlist';" value="Vissza" class="admin-button" />
    </td>    
  </tr>
</table>
