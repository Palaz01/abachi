 ...
 <!--product view page starts here-->
        <div class="product_view_page">
          ...
          <div class="container">
            <div class="product">
	      <a class="first" href="{$data.image}" rel="prettyOverlay[gallery]" title="{$data.title}"><img class="first" border="0" width="228" src="{#pt#}{$data.image}&w=228&zc=1" alt="{$data.imgalt}" title="{$data.imgtitle}" hspace="5" vspace="5" /></a>
              ...
              <div class="text_container">
                ...
                {foreach from=$editions item=edition}
                  <tr>
                    ...
                    <td align="right">{$edition.price|commify:-1:',':'.'} Ft</td>
                    <td align="right">
                ...
                <div class="price_container">
                  <p class="big_price"><span><span><b>Ára:</b> {$data.price|commify:-1:',':'.'} Ft</span></span></p>
            ...
            <div class="jquery_gallery_container">
              <div class="jquery_gallery">
                ...
                {foreach from=$images item=image}
                  <li><a href="upload/products/{$image.filename}" rel="gallery"><img style="border:none;" src="{#pt#}upload/products/{$image.filename}&amp;h=128" alt="{$image.imgalt}" title="{$image.imgtitle}" /></a></li>
                {/foreach}
                </ul>
              </div>
            </div>
               ...
               {foreach from=$hasonlo item=h}
                 ...
                 <div class="product">
                  ...
                  <div class="text_container">
                    ...
                    <p class="price"><span><span><b>Ára:</b> {$h.price} Ft</span></span></p>
                    
                    <a href="{$h.filename}.html" title="" class="details_link">RÉSZLETEK</a>
                    <a href="#" title="" class="cart_link">KOSÁRBA</a>
